...
# DEFAULTS:
[ -z ${dotfilesrepo+x} ] && dotfilesrepo="https://github.com/NikulinVs/dotfiles"
...
pythonvimplugs() {
	git clone https://github.com/gmarik/Vundle.vim.git /home/"$name"/.vim/bundle/Vundle.vim
...
keyboardlayout() {
	mkdir /home/"$name"/src
	git clone https://github.com/nonpop/xkblayout-state /home/"$name"/src/xkb
	cd /home/"$name"/src/xkb
	make
	cp xkblayout-state /usr/bin/
	cd ../..
	rm -rf src/
	cd /
}
